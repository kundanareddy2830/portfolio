  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.p
            className="text-3xl sm:text-4xl lg:text-5xl font-semibold mb-3 text-white"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <button
              ...
              className="bg-gray-300/90 text-slate-800 px-8 py-4 rounded-lg font-semibold hover:bg-opacity-90 transition-all duration-300 hover:scale-105"
            >
              View My Work
            </button>
            <a
            ...
            <a
              href="/images/projects/my-resume.pdf"
              download
              className="bg-gray-300/90 text-slate-800 px-8 py-4 rounded-lg font-semibold hover:bg-opacity-90 transition-all duration-300 hover:scale-105 flex items-center justify-center"
            >
              Download CV
            </a>
            <button
